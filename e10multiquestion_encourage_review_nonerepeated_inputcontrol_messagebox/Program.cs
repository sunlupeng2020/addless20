...
namespace singlequestion_dountilright_random
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string scoreTip;//成绩提示
            string encouragement;//鼓励语言
            ...
            scoreTip = string.Format("您的成绩是：{0}分。\n", achievement);
            switch (achievement)//根据不同成绩显示不同的鼓励。
            {
                case 100:
                    //Console.WriteLine("哇哦~~~ 你太棒了！你是我们的骄傲！继续努力！");
                    encouragement = "哇哦~~~ 你太棒了！你是我们的骄傲！继续努力！";
                    break;
                case 80:
                    //Console.WriteLine("你真棒！继续努力！");
                    encouragement = "你真棒！继续努力！";
                    break;
                case 60:
                    //Console.WriteLine("不错哦！继续努力！");
                    encouragement = "不错哦！继续努力！";
                    break;
                default:
                    //Console.WriteLine("你有很大的进步空间！继续努力！");
                    encouragement = "你有很大的进步空间！继续努力！";
                    break;
            }
            //Console.Write(sb.ToString());//显示题目记录
            MessageBox.Show("题目及得分：\n"+sb.ToString()+scoreTip+encouragement,"测验反馈");
            //Console.ReadKey();
        }
    }
}